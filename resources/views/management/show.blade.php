            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="small font-italic text-muted mb-4">{{$user->anket_status}}</div>
                        @if($user->anket_status == \App\Enum\Anket\AnketStatusEnum::NEW)
                            <button type="submit" class="btn btn-outline-primary">On Moderation</button>
                        @endif
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('management.upload.photo', ['user' => $user])}}" method="post"  enctype="multipart/form-data">
                            @csrf
                ...
                <div class="card " style="margin-bottom: 150px;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('management.upload.video', ['user' => $user])}}" method="post"  enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex justify-content-between gap-2">
                                <input type="file" name="file" class="form-control">
                                <div>
