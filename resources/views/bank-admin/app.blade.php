...
<div class="d-flex justify-content-between flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <div class="d-flex">
    <h5 class="my-0 mr-md-auto font-weight-normal">Bank Admin</h5>

        <nav class="my-2 my-md-0 mr-md-3">
            <a class="p-2 text-dark" href="{{route('bank-admin.index')}}">Home</a>
        </nav>
    </div>
    <form action="{{route('bank-admin.logout')}}" method="post">
        @csrf
