...
class AdminController extends Controller
{
    ...
    public function getDataListUserStatistic(Request $request){
        ...
        $users = new UserLogic($params,[
            ...
            DB::raw("CONCAT(COALESCE(UserCooperation.utm_source, ''),CHAR(10), CHAR(13), COALESCE(UserCooperation.utm_medium, ''),CHAR(10), CHAR(13), COALESCE(UserCooperation.utm_campaign, ''),CHAR(10), CHAR(13), COALESCE(UserCooperation.utm_term, ''),CHAR(10), CHAR(13), COALESCE(UserCooperation.utm_advertiser, '')) as UTM") ,
        ]);
