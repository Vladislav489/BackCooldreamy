...
class AssignAnketContentFiles extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:assign-anket-content-files';
    ...
    public function handle()
    {
        ...
        foreach ($folders as $folder) {
            ...
            if ($folderName < 40000 || $folderName > 80000) {
                continue;
            }
            ...
            if ($user) {
                ...
                $avaFiles = Storage::disk('public')->allFiles("images/{$folderName}/content");

                if (count($avaFiles)) {
                    foreach ($avaFiles as $file) {
                        $fileName = basename($file);
                        $fileUrl = "$baseUrl/{$folderName}/content/$fileName";
                    ...
                    $this->error('Not found for user: ' . $user->id);
                }
            }
        }
    }
