...
class AssignAnketsProfileFFiles extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:assign-ankets-profile-f-files';
    ...
    public function handle()
    {
        ...
        foreach ($folders as $folder) {
            ...
            if ($user) {
                ...
                $avaFiles = Storage::disk('public')->allFiles("images/{$folderName}/profile");
                if (count($avaFiles)) {

                    foreach ($avaFiles as $file) {
                        $fileName = basename($file);
                        $fileUrl = "$baseUrl/{$folderName}/profile/$fileName";
